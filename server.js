...
function serve(res, pathname) { const pages = { "/": [INDEX_FILE, "text/html; charset=utf-8"], "/learn_english": [INDEX_FILE, "text/html; charset=utf-8"], "/learn_english/": [INDEX_FILE, "text/html; charset=utf-8"], "/index": [INDEX_FILE, "text/html; charset=utf-8"], "/index.html": [INDEX_FILE, "text/html; charset=utf-8"], "/login": [path.join(__dirname, "login.html"), "text/html; charset=utf-8"], "/login.html": [path.join(__dirname, "login.html"), "text/html; charset=utf-8"], "/register": [path.join(__dirname, "register.html"), "text/html; charset=utf-8"], "/register.html": [path.join(__dirname, "register.html"), "text/html; charset=utf-8"], "/forgot-password": [path.join(__dirname, "forgot-password.html"), "text/html; charset=utf-8"], "/forgot-password.html": [path.join(__dirname, "forgot-password.html"), "text/html; charset=utf-8"], "/reset-password": [path.join(__dirname, "reset-password.html"), "text/html; charset=utf-8"], "/reset-password.html": [path.join(__dirname, "reset-password.html"), "text/html; charset=utf-8"], "/auth.css": [path.join(__dirname, "auth.css"), "text/css; charset=utf-8"], "/auth.js": [path.join(__dirname, "auth.js"), "text/javascript; charset=utf-8"] }; if (pathname === "/favicon.ico") { res.writeHead(204, SECURITY_HEADERS); return res.end(); } const page = pages[pathname]; if (!page) return json(res, 404, { error: "Page introuvable." }); res.writeHead(200, { ...SECURITY_HEADERS, "Content-Type": page[1], "Cache-Control": "no-cache" }); fs.createReadStream(page[0]).pipe(res); }
